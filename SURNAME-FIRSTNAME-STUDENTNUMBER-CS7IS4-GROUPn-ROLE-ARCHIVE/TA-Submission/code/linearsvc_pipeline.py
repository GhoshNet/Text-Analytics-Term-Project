...
def main():
    ...
    summary_df.to_csv(os.path.join(RESULTS_DIR, 'linearsvc_results_summary.csv'), index=False)
    fold_df.to_csv(os.path.join(RESULTS_DIR, 'linearsvc_results_per_fold.csv'), index=False)
    ...
    pairwise_df.to_csv(os.path.join(RESULTS_DIR, 'linearsvc_statistical_tests.csv'), index=False)

    print("\nResults saved to results/:")
    print("  linearsvc_results_summary.csv   — mean/std summary per scenario")
    print("  linearsvc_results_per_fold.csv  — per-fold raw values")
    print("  linearsvc_statistical_tests.csv — Friedman + Wilcoxon/Holm pairwise tests")
